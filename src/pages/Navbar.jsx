...
const Navbar = () => {
    ...
    return (
        <div className='Navbar'>
            ...
            {/* Main Navbar */}
            <div className="nav-list flex justify-between items-center h-16 px-8 bg-white shadow-md">
                ...
                {/* Mobile Menu */}
                {isOpen && (
                    <div className="absolute w-full h-full z-10 items-center top-0 left-0 w-full bg-green-300  overflow-hidden md:hidden">
                ...
                <div className="navsearch flex items-center gap-4 ml-6">
                    <input
                        type="text"
                        placeholder='Search'
                        className="px-4 py-2 mb-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-600"
                    />
                ...
                <div className="menu-btns text-3xl md:hidden z-50 mb-4" onClick={toggle}>
